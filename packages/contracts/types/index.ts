...
export type PresenceLabel = "social" | "available" | "busy" | "knock_if_urgent" | "do_not_disturb" | "sleeping" | "at_class" | "at_library" | "away" | "unknown";
...
export interface SatelliteOrbitSample {
  at: string;
  lat: number;
  lng: number;
}
...
export interface SatelliteOrbit {
  ...
  sub_lat: number;
  sub_lng: number;
  track: Array<SatelliteOrbitSample>;
}

export interface AmbientSatelliteOrbitsPayload {
  satellites: Array<SatelliteOrbit>;
  as_of: string;
}
...
export interface AmbientSatelliteOrbitsEvent {
  event_id: string;
