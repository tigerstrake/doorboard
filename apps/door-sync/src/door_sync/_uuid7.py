...
Time-ordered UUIDs without a third-party dependency. Kept in-service (same
approach as door-media) rather than shared, since it is a handful of lines and
the workspace has no shared id package.
"""
